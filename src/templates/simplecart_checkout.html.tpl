...
<section class="section">
  <div class="container">
    <h1 class="title is-4"><{$smarty.const._MD_PLAYLISTBUILDER_CHECKOUT}></h1>
    ...
    <{if $simplecart_order_success}>
      ...
      <{if $simplecart_payment.qr_image}>
        <div class="box has-text-centered mt-4">
          <h3 class="title is-5"><{$smarty.const._MD_PLAYLISTBUILDER_PAY_WITH_SEPA}></h3>
          <img src="<{$simplecart_payment.qr_image}>" alt="SEPA QR Code" style="max-width: 280px;">
          <p class="help"><{$smarty.const._MD_PLAYLISTBUILDER_SCAN_TO_PAY}></p>
        </div>
      <{/if}>
    ...
    <{if !$simplecart_order_success && $simplecart_cart_items|@count}>
      ...
      <form method="post" action="<{$simplecart_module_url}>checkout.php">
        ...
        <div class="field">
          <label class="label"><{$smarty.const._MD_PLAYLISTBUILDER_NAME}> <span class="tag is-info is-light">verplicht</span></label>
          <div class="control">
        ...
        <div class="field">
          <label class="label"><{$smarty.const._MD_PLAYLISTBUILDER_EMAIL}> <span class="tag is-info is-light">verplicht</span></label>
          <div class="control">
        ...
        <div class="field">
          <label class="label"><{$smarty.const._MD_PLAYLISTBUILDER_PHONE}></label>
          <div class="control">
        ...
        <div class="field">
          <label class="label"><{$smarty.const._MD_PLAYLISTBUILDER_ADDRESS}></label>
          <div class="control">
        ...
        <div class="field">
          <label class="label"><{$smarty.const._MD_PLAYLISTBUILDER_HELP}></label>
          <div class="control">
            <label class="radio">
              ...
              <{$smarty.const._MD_PLAYLISTBUILDER_HELP_1}>
            </label>
            <label class="radio">
              ...
              <{$smarty.const._MD_PLAYLISTBUILDER_HELP_2}>
            </label>
            <label class="radio">
              ...
              <{$smarty.const._MD_PLAYLISTBUILDER_HELP_3}>
            </label>
            <label class="radio">
              ...
              <{$smarty.const._MD_PLAYLISTBUILDER_HELP_4}>
            </label>
          </div>
        </div>
        ...
        <div class="field">
          <div class="control">
            <button type="submit" class="button is-primary"><{$smarty.const._MD_PLAYLISTBUILDER_PLACE_ORDER}></button>
          </div>
        </div>
      </form>
